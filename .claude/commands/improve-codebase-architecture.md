...
A **deep module** has "a small interface hiding a large implementation" (Ousterhout, *A Philosophy of Software Design*). Deep modules enhance testability, AI-navigability, and enable boundary testing rather than internal testing.
...
- **Dependency category**: See the Reference section below for the four categories
...
4. Dependency strategy (how deps are handled — see Reference section)
5. Trade-offs
...
Create a refactor RFC as a GitHub issue. Use the issue template in the Reference section below. Do NOT ask the user to review before creating — just create it and share the URL.
